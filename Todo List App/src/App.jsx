...
function App() {
  ...
  const handleDelete = (e, id) => {
    ...
    setTodos(newTodos)
    saveToLS()
    confirm("do you really wants to delete?")
  }
    ...
    < >
      ...
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        ...
        <div className="addTodo my-5 flex flex-col gap-4">
          <h2 className='text-2xl font-bold'>Add a Todo List</h2>
          <div className="flex">
            <input onChange={handleChange} value={todo} placeholder='Task Title' type="text" className='w-full rounded-full px-5 py-1' />
...
// https://lordicon.com/   u can pick icons from here